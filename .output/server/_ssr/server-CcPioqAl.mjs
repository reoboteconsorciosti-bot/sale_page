...
import { n as parseCookies, r as toResponse, t as H3Event } from "../_libs/h3-v2+rou3.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Cc2SbtOO.mjs");
